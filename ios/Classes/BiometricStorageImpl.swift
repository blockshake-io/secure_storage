...
enum BiometricAccessControl: String {
    case biometryNone
    case biometryAny
...
class InitOptions {
  init(params: [String: Any]) {
    biometricAccessControl = BiometricAccessControl(rawValue: params["biometricAccessControl"] as? String ?? "biometryAny")
  }
  let biometricAccessControl: BiometricAccessControl?
}
...
class BiometricStorageFile {
  ...
  private func baseQuery(_ result: @escaping StorageCallback) -> [String: Any]? {
    ...
    if initOptions.biometricAccessControl != BiometricAccessControl.biometryNone {
  ...
  private func accessControl(_ result: @escaping StorageCallback) -> SecAccessControl? {
    ...
    if initOptions.biometricAccessControl == BiometricAccessControl.biometryCurrentSet {
