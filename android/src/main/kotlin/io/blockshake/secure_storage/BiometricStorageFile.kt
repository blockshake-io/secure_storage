...
data class InitOptions(
    val biometricAccessControl: BiometricAccessControl = BiometricAccessControl.biometryAny
)

enum class BiometricAccessControl {
    biometryNone,
    biometryAny,
    biometryCurrentSet
}
...
class BiometricStorageFile(
    ...
    private val cryptographyManager = CryptographyManager {
        setUserAuthenticationRequired(options.biometricAccessControl != BiometricAccessControl.biometryNone)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            if (options.biometricAccessControl == BiometricAccessControl.biometryCurrentSet) {
